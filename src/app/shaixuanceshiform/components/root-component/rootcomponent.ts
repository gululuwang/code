...
import { ShaixuanceshiRepository } from '../../models/shaixuanceshirepository';
...
import { ShaixuanceshiProxy } from '../../models/shaixuanceshiproxy';
...
@Component({
    ...
    providers: [
        ...
        { provide: Repository, useExisting: ShaixuanceshiRepository },
        LangService,
        ...
        { provide: FORM_ID, useValue: "0ca453e9-e509-4c45-bd33-4e8286964931" },
...
export class RootComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    ...
    QuerySolutionqueryscheme1 = this.langService.transform('query-scheme-1', this.lang, "默认筛选方案2"); 
    fieldConfigsqueryscheme1 = [
        {
            "id": "ccb12f7e-a4c3-4543-9edb-98ea421bb25a",
            "labelCode": "birthday",
            "code": "birthday",
            "name": this.langService.transform('QueryScheme/query-scheme-1/ccb12f7e-a4c3-4543-9edb-98ea421bb25a', this.lang, "生日"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/ccb12f7e-a4c3-4543-9edb-98ea421bb25a/placeHolder', this.lang, ""),
            "control": {"id":"ccb12f7e-a4c3-4543-9edb-98ea421bb25a","controltype":"single-date","require":false,"format":"yyyy-MM-dd","returnFormat":"yyyy-MM-dd","isDynamicDate":true}
        },
        {
            "id": "92c743be-499a-41c4-a19e-c8f858337e09",
            "labelCode": "ID",
            "code": "ID",
            "name": this.langService.transform('QueryScheme/query-scheme-1/92c743be-499a-41c4-a19e-c8f858337e09', this.lang, "主键"),
            "placeHolder": this.langService.transform('QueryScheme/query-scheme-1/92c743be-499a-41c4-a19e-c8f858337e09/placeHolder', this.lang, ""),
            "control": {"id":"92c743be-499a-41c4-a19e-c8f858337e09","controltype":"single-date","require":false,"format":"yyyy/MM/dd","returnFormat":"yyyy年MM月dd日","modalConfig":{"modalCmp":null,"mapFields":null,"showHeader":true,"title":"","showCloseButton":true,"showMaxButton":true,"width":800,"height":600,"showFooterButtons":true,"footerButtons":[]},"enableCustomFormat":true,"isDynamicDate":true}
        }]
