...
import { shaixuanceshiFormRoutingModule } from './routing';
...
@NgModule({
    ...
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/yyy3/yyy3mk1/web/bo-shaixuanceshi-front/shaixuanceshiform/'},
...
export class shaixuanceshiFormModule {
    constructor(public trans: TranslateResolveService) { }
}


export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/yyy3/yyy3mk1/web/bo-shaixuanceshi-front/shaixuanceshiform/i18n/', '.json');
}