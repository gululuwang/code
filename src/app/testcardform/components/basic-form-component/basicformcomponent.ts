...
import { basicformviewmodelbatchAppendByPathWithAttachment1Handler } from '../../viewmodels/handlers/basicformviewmodelbatchappendbypathwithattachment1handler';
import { basicformviewmodelmethod11Handler } from '../../viewmodels/handlers/basicformviewmodelmethod11handler';
import { basicformviewmodelmethod21Handler } from '../../viewmodels/handlers/basicformviewmodelmethod21handler';
...
@Component({
    ...
    providers: [
        ...
        TestCardFormFrmControllerService1,
        { provide: ViewModel, useClass: BasicFormViewmodel },
        { provide: EXCEPTION_HANDLER, useValue: null },
        { provide: COMMAND_HANDLERS_TOKEN, useClass: basicformviewmodelbatchAppendByPathWithAttachment1Handler, multi: true },
        { provide: COMMAND_HANDLERS_TOKEN, useClass: basicformviewmodelmethod11Handler, multi: true },
        { provide: COMMAND_HANDLERS_TOKEN, useClass: basicformviewmodelmethod21Handler, multi: true },
]
})
export class BasicFormComponent extends FrameComponent implements OnInit, AfterViewInit, OnDestroy {
    @ViewChild('helpId')
    helpId: LookupGridComponent;
    ...
    helpIdLookupPicked = (data) => {
        return this.viewModel.basicformviewmodelbatchAppendByPathWithAttachment1.call(this, data);
    }; 
    ...
    LookupEdithelpIdDialogTitle = this.langService.transform('LookupEdit/helpId/dialogTitle', this.lang, "");
    helpId_PlaceHolder = this.langService.transform('LookupEdit/helpId/placeHolder', this.lang, "");
    helpIdQuickSelect = {
        "enable": false,
        "showItemsCount": 10,
        "showMore": true
    ...
    i1_df866bb8_fliu_PlaceHolder = this.langService.transform('NumericBox/i1_df866bb8_fliu/placeHolder', this.lang, "");
    i1Df866bb8FliuTextOptions = {
        "type": "number",
        "useThousands": true,
        "precision": 0,
    }
    version_fb798347_1ujk_PlaceHolder = this.langService.transform('DateBox/version_fb798347_1ujk/placeHolder', this.lang, "");
    d1_8fe1d305_5qmt_PlaceHolder = this.langService.transform('DateBox/d1_8fe1d305_5qmt/placeHolder', this.lang, "");
    id_47464863_40ml_PlaceHolder = this.langService.transform('TextBox/id_47464863_40ml/placeHolder', this.lang, "");
    s1_74c1cc20_pcip_PlaceHolder = this.langService.transform('TextBox/s1_74c1cc20_pcip/placeHolder', this.lang, "");
}