...
import { AttComponent } from './components/att-component/attcomponent';
...
@NgModule({
    ...
    providers: [
        ...
        FileViewerService,
        { provide: FORM_PATH_TOKEN, useValue:'/apps/jiangsion/web/web/bo-test-front/testcardform/'},
...
export class testCardFormModule {
    constructor(public trans: TranslateResolveService) { }
}


export function createTranslateLoader(http: HttpClient) {
    return new TranslateHttpLoader(http, '/apps/jiangsion/web/web/bo-test-front/testcardform/i18n/', '.json');
}